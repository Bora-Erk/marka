  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10">
      <div className="flex">
        ...
        <div
          className="w-1/3 bg-yellow-400 flex flex-col justify-center items-start px-10 py-20 text-black bg-no-repeat bg-right bg-[length:370px]"
          style={{
...
export default BestsellerProducts2;
